"""
Django settings for drugquizbackend project.
...
ROOT_URLCONF = 'drugquizbackend.urls'
...
WSGI_APPLICATION = 'drugquizbackend.wsgi.application'
...
USE_RENDER = os.getenv("USE_RENDER_DB") == "1"
